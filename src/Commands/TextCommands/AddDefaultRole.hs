...
addDefRoleCommand m = do
    ...
    ifElse allowed (addRole m) (sendMessage $ R.CreateMessage (messageChannel m) (append (pingUserText m) ", you do not have the permission to run this command."))
...
insertRoles [] _ m = sendMessage $ R.CreateMessage (messageChannel m) (append (pingUserText m) ", you need to @roles! no roles found in the message!")
