...
itemTable = table
  "item"
  (pItem ItemT { itemId      = tableField "id"
...
typeTable = table "type" (pType TypeT { typeName = tableField "type" })
...
abilityTable = table
  "ability"
  (pAbility AbilityT { abilityId   = tableField "id"
...
moveTable = table
  "move"
  (pMove MoveT { moveId               = tableField "id"
...
type PokemonF
  = PokemonT (Field SqlBool) (Field SqlFloat8) (Field SqlInt4) (Field SqlText)
...
pokemonTable = table
  "pokemon"
  (pPokemon PokemonT { pokemonId     = tableField "id"
...
pokemonMoveTable = table
  "pokemon_moves_move"
  (pPokemonMove PMT { pmPokemonId = tableField "pokemonId"
...
pokemonAbilityTable = table
  "pokemon_abilities_ability"
  (pPokemonAbility PAT { paPokemonId = tableField "pokemonId"
...
pokemonTypeTable = table
  "pokemon_types_type"
  (pPokemonType PTT { ptPokemonId = tableField "pokemonId"
...
ocTable = table
  "object_class"
  (pOC OCT { ocId = tableField "id", ocClass = tableField "class" })
